 ...
 * License: MIT
 *
 * HEX input by Thiibo <https://github.com/Thiibo>
 * --------------------------------------------------------------
 */
...
(function(win, doc, name) {
    ...
    var html = doc.documentElement,
        HEX = 'HEX',
        testHex = /^\#([0-9|a-f|A-F]{3}|[0-9|a-f|A-F]{6})$/g,
        children = 'children',
        top = 'top',
        right = 'right',
        left = 'left',
    ...
    (function($$) {
        ...
        self.className = cn;
        self.innerHTML = '<div><div class="' + cn + ':sv"><div></div><div></div><div></div><i></i></div><div class="' + cn + ':h"><div></div><i></i></div><div class="' + cn + ':a"><div></div><div></div><i></i></div></div><div class="'+ cn + ':hex"><input type="text"></div>';
        self.lastChild.firstChild.value = $$[HEX](value());
        ...
        function doApply(isFirst, to) {
            ...
            doExit = function() {
                ...
                eventsLet(X.firstChild, inputEvents, doInputX);
            ...
            if (isFirst) {
                ...
                eventsSet(X.firstChild, inputEvents, doInputX);
                doFit();
            }
            ...
            function doInputX(e) {
              if (testHex.test(this.value)) {
                data = RGB2HSV($$[HEX](this.value));
